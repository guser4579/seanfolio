...
// Public TestFlight invite for kebab (rendered as the CTA on /kebab).
export const KEBAB_TESTFLIGHT_URL = 'https://testflight.apple.com/join/hVRTZDfq';
...
export const WORK = [
  ...
  },
  {
    ...
    // featured drives the accent bar AND renders as the leading blue meta
    // token ("personal app"), replacing the "my favorite" label.
    featured: 'personal app',
    blurb:
      'Designing and building an iOS app for keeping what you notice - threaded notes, collections, reminders, and entries that resurface.',
    meta: '2026',
    lede:
      'Designing and building an iOS app for keeping what you notice - threaded notes, collections, reminders, and entries that resurface.',
    company: 'Personal',
